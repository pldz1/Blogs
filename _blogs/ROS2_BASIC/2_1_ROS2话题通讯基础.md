...
![Topic-MultiplePublisherandMultipleSubscriber](/_pics/ROS2_BASIC/2_Topic-MultiplePublisherandMultipleSubscriber.gif)
...
> ![命名的问题](/_pics/ROS2_BASIC/2_right_package_name.png)
...
![C/C++订阅和发布基础消息](/_pics/ROS2_BASIC/2_basic_build_result.png)
...
![创建Python功能包](/_pics/ROS2_BASIC/2_create_basic_python_package.png)
...
![话题通讯多对多](/_pics/ROS2_BASIC/2_basic_multi_communication_result.png)
